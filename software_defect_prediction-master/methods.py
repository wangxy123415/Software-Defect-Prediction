...
def run_method(method, X, y, n_clfs=3, fs_functions=None, score_name="acc"):
    if method == "forward_selection":
        ...
        for fs in fs_functions:
            ...
            if fs in ["pearson", "fisher"]:
                ...
                scores, selected_features = ut.compute_feature_curve(clf, X, y, 
                                                                     ft_ranks=ft_ranks, 
                                                                     step_size=3,
                                                                     score_name=score_name)
                ...
                # Greedy selection with auc
                scores, selected_features = ut.greedy_selection(clf, X, y, score_name=score_name)
    elif method == "KNN":
